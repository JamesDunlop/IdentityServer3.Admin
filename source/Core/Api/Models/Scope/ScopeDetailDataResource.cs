            ...
            if (scope.Properties != null)
            {
                var props =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            update = url.LinkWithoutProtocol(Constants.RouteNames.UpdateScopeProperty,
                                new
                                {
            ...
            if (scope.ScopeClaimValues != null)
            {
                var claimValues =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveScopeClaim, new
                            {
                                subject = scope.Subject,
                                id = c.Id
                            }),
                            update = url.LinkWithoutProtocol(Constants.RouteNames.UpdateScopeClaim, new
                            {
                                subject = scope.Subject,
                                id = c.Id
                            }),
                ...
                this["Claims"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddScopeClaim, new { subject = scope.Subject })
                    }
                };
            }
            if (scope.ScopeSecretValues != null)
            {
                var scopeSecrets =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveScopeSecret, new
                            {
                                subject = scope.Subject,
                                id = c.Id
                            }),
                            update = url.LinkWithoutProtocol(Constants.RouteNames.UpdateScopeSecret, new
                            {
                                subject = scope.Subject,
                                id = c.Id
                            }),
                ...
                this["Secrets"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddScopeSecret, new { subject = scope.Subject })
                    }
                };
            }
            #endregion
