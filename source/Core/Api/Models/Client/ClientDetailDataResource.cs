            ...
            if (client.Properties != null)
            {
                var props =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            update = url.LinkWithoutProtocol(Constants.RouteNames.UpdateClientProperty,
                                new
                                {
            ...
            if (client.Claims != null)
            {
                var claims =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientClaim, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["Claims"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientClaim, new { subject = client.Subject })
                    }
                };
            }
            #endregion  
            ...
            if (client.ClientSecrets != null)
            {
                var clientSecrets =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientSecret, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["ClientSecrets"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientSecret, new { subject = client.Subject })
                    }
                };
            }
            #endregion
            ...
            if (client.IdentityProviderRestrictions != null)
            {
                var clientIdentityProviderRestrictions =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientIdPRestriction, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["IdentityProviderRestrictions"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientIdPRestriction, new { subject = client.Subject })
                    }
                };
            }
            #endregion
            ...
            if (client.PostLogoutRedirectUris != null)
            {
                var postLogoutRedirectUris =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientPostLogoutRedirectUri, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["PostLogoutRedirectUris"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientPostLogoutRedirectUri, new { subject = client.Subject })
                    }
                };
            }
            #endregion  
            ...
            if (client.RedirectUris != null)
            {
                var redirectUris =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientRedirectUri, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["RedirectUris"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientRedirectUri, new { subject = client.Subject })
                    }
                };
            }
            #endregion  
            ...
            if (client.AllowedCorsOrigins != null)
            {
                var alowedCorsOrigins =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientCorsOrigin, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["AllowedCorsOrigins"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientCorsOrigin, new { subject = client.Subject })
                    }
                };
            }
            #endregion 
            ...
            if (client.AllowedCustomGrantTypes != null)
            {
                var allowedCustomGrantTypes =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientCustomGrantType, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["AllowedCustomGrantTypes"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientCustomGrantType, new { subject = client.Subject })
                    }
                };
            }
            #endregion         
            ...
            if (client.AllowedScopes != null)
            {
                var allowedScopes =
                    ...
                    select new
                    {
                        ...
                        Links = new
                        {
                            delete = url.LinkWithoutProtocol(Constants.RouteNames.RemoveClientScope, new
                            {
                                subject = client.Subject,
                                id = c.Id
                            })
                ...
                this["AllowedScopes"] = new
                {
                    ...
                    Links = new
                    {
                        create = url.LinkWithoutProtocol(Constants.RouteNames.AddClientScope, new { subject = client.Subject })
                    }
                };
            }
            #endregion    
